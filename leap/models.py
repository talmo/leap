...
def leap_cnn(img_size, output_channels, filters=64, summary=False):
    """
...
def hourglass(img_size, output_channels, filters=64, summary=False):
    """
    Creates and compiles network model.
...
#     x_out = residual_bottleneck_module(x9, output_filters=output_channels, prefix="x_out", activation="linear")
...
def stacked_hourglass(img_size, output_channels, filters=64, summary=False):
    """
    Creates and compiles network model.
